...
import io.github.dbmdz.metadata.server.backend.impl.jdbi.identifiable.entity.geo.location.GeoLocationRepositoryImpl;
import io.github.dbmdz.metadata.server.backend.impl.jdbi.identifiable.entity.geo.location.HumanSettlementRepositoryImpl;
import io.github.dbmdz.metadata.server.backend.impl.jdbi.identifiable.entity.work.ItemRepositoryImpl;
import io.github.dbmdz.metadata.server.backend.impl.jdbi.identifiable.resource.DigitalObjectLinkedDataFileResourceRepositoryImpl;
import io.github.dbmdz.metadata.server.backend.impl.jdbi.identifiable.resource.DigitalObjectRenderingFileResourceRepositoryImpl;
import io.github.dbmdz.metadata.server.backend.impl.jdbi.identifiable.resource.FileResourceMetadataRepositoryImpl;
import io.github.dbmdz.metadata.server.backend.impl.jdbi.identifiable.resource.ImageFileResourceRepositoryImpl;
import io.github.dbmdz.metadata.server.backend.impl.jdbi.identifiable.resource.LinkedDataFileResourceRepositoryImpl;
